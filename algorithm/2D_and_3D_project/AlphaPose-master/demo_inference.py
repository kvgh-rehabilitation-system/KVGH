...
parser.add_argument('--cfg', type=str, required=False,default='256x192_res50_lr1e-3_1x.yaml',
                    help='experiment configure file name')
parser.add_argument('--checkpoint', type=str, required=False,default='halpe26_fast_res50_256x192.pth',
...
parser.add_argument('--outdir', dest='outputpath',
                    help='output-directory', default="D:/code/DTW_data/alphapose")
...
parser.add_argument('--video', dest='video',
                    help='video-name', default=r"D:/code/DTW_data/mp4/golf_vid2.mp4")
...
if __name__ == "__main__":
    ...
    if args.save_video and mode != 'image':
        ...
        if mode == 'video':
            video_save_opt['savepath'] = os.path.join(args.outputpath, os.path.basename(input_source))
        else:
            video_save_opt['savepath'] = os.path.join(args.outputpath, 'AlphaPose_webcam' + str(input_source) + '.mp4')
        video_save_opt.update(det_loader.videoinfo)
        writer = DataWriter(cfg, args, save_video=True, video_save_opt=video_save_opt, queueSize=queueSize,json_name=(os.path.basename(input_source).replace(".mp4", ".json"))).start()
    else:
